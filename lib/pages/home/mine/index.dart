...
import 'package:flutter_getx_app/pages/home/mine/mock.dart';
              ...
              child: Row(
                ...
                children: [
                  ...
                  InkWell(
                    ...
                    onTap: () => Get.toNamed('/mine/friends'),
                  ),
                  adapterDrive(),
                  InkWell(
                    child: adapterItem(mine.friends, '粉丝'),
    ...
    return Center(
      child: Column(
        ...
        children: [
          CircleAvatar(
            radius: 48,
            backgroundImage: NetworkImage(mine.avatar),
          ),
          Container(
          ...
          Container(
            ...
            child: Wrap(
              ...
              spacing: 12,
              runSpacing: 6,
              children: List.generate(mine.tags.length, (index) {
                if (index < mine.tags.length) {
                  return InkWell(
    ...
    return Column(
      ...
      children: [
        Text(
          "$num",
          style:
              TextStyle(fontSize: WcaoTheme.fsXl, fontWeight: FontWeight.bold),
        ),
        Text(text, style: TextStyle(color: WcaoTheme.secondary)),
      ],
    );
  }
