                    ...
                    Container(
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          Row(
                            children: [
                              iconText(Icons.favorite_border_outlined,
                                  item.fav.toString()),
                              Container(
                                margin: const EdgeInsets.only(left: 24),
                                child: iconText(Icons.add_comment_outlined,
    ...
    return Row(
      ...
      children: [
        ...
        Padding(
          ...
          child: Text(text, style: TextStyle(color: WcaoTheme.secondary)),
        ),
      ],
    );
  }
